function alterar() 
{
    ...
    xmlHttp.open("GET", "http://localhost/3DAW/copa/alterar.php?nome=" + nome + "&nomeAlterado=" + nomeAlterado + "&tecnico=" + tecnico
...
function buscar() 
{
    ...
    xmlHttp.open("GET", "http://localhost/3DAW/copa/buscar.php?nome=" + nome);
    xmlHttp.send();
}